#pragma checksum "C:\Users\PhongNV\Documents\Phong\SSV\QLNVSSV\QLNVSSV.WebApp\Pages\Employee.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "342c7d250958aca8671bd835b853ee39f985dc7a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"342c7d250958aca8671bd835b853ee39f985dc7a", @"/Pages/Employee.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "342c7d250958aca8671bd835b853ee39f985dc7a6465", async() => {
            }
            );
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "342c7d250958aca8671bd835b853ee39f985dc7a10837", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
<script>
    ...
    function Delete(id) {
   ");
            WriteLiteral(@"     fetch('http://localhost:37919/api/Employee/2', {
            method: 'DELETE'
        })
            .then(response => response.json())
            .then(data => {
    ...
    function editItem() {
        ...
        var name = document.getElementById('txt_name')
        var address =");
            WriteLiteral(@" document.getElementById('txt_address')
        var email = document.getElementById('txt_email')
        var ipfile = document.getElementById('ip_file')
        var lbfile = document.getElementById('lb_file')
        var data = {
    ...
    function LoadPaging() {
        ...
        html += `<li class=""page-it");
            WriteLiteral(@"em""><a class=""page-link"" href=""#"">1</a></li>`;
    ...
    function GetcountRecord() {
        ...
        fetch('http://localhost:37919/api/Employee/GetCount')
            ...
            .then(data => {
                ...
                $('#pagelast').attr('href', """")
                pageEnd = Math.floor(totalRecord / pagesiez)
            ...
            WriteLiteral(@"    </li>`;
                ...
                html += `<li class=""page-item""><a id=""prev1"" class=""page-link"" href=""#"">${pageTarget + 1}</a></li>`
                html += `<li class=""page-item""><a id=""mid"" class=""page-link"" href=""#"">${pageTarget + 2}</a></li>`
                html += `<li class=""page-item""><a id=""next1"" class=""page-link"" href=""#"">${pageTarget + 3}</a></li>`
    ...
    function CallPageing() {
        ...
        document.querySelectorAll('.page-item').forEach(item => {
            item.addEventListener('click', event => {
                ...
                $('#prev1').text(parseInt(pageTarget-1))
                $('#mid').text(parseInt(pageTarget))
                $('#next1').text(parseInt(pageTarget + 1))
